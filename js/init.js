(function($) {
    $(function() {
        ...
        function initContact() {
            document.getElementById("contact-button").addEventListener("click", contactListener);
        }

        function contactListener() {
            var form = document.getElementById("contact");
            var message = form.querySelector(".message").value || "I want to say you something:";
            var subject = "Hi! I'm " + (form.querySelector(".name").value || "someone");
            var target = "mailto:contact@daniguardiola.me?subject=" + encodeURIComponent(subject) + "&body=" + encodeURIComponent(message);
